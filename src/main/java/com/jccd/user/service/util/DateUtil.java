...
public class DateUtil {
    ...
    /**
     * The constant YYYYMMDDHHMMSS5
     */
    public final static String YYYYMMDDHHMMSS5 = "yyyyMMdd-HH:mm:ss";
    /**
     * The constant YYYYMMDDHHMMSSMS2.
     */
    public final static String YYYYMMDDHHMMSSMS2 = "yyyy-MM-dd HH:mm:ss.S";

    public final static String YYYYMMDDHHMMSSMS3 = "yyyy-MM-dd HH:mm:ss.SSS";

    public final static String YYYYMMDDHHMMSSMS5 = "yyyyMMdd-HH:mm:ss.SSS";
    ...
    public static String format(Object date, String pattern) {
        ...
        return simpleDateFormat.format(toDate(date));
    }
    ...
    public static int getMonthDayNumber(Date date){
        ...
        //将时间转换为毫秒
        long thisMonthFirstDay = calendar.getTimeInMillis();
        //设置时间为下个月1号
        calendar.set(Calendar.MONTH, monthIndex +1);
        //将时间转换为毫秒
        long nextMonthFirstDay = calendar.getTimeInMillis();
        //计算日期间隔天数，即为当月的天数
        int dayGap = (int)((nextMonthFirstDay - thisMonthFirstDay)/(24*3600*1000));
        return dayGap;
    }
     ...
     *
     * @param firstDate        较大的时间
     * @param secondDate 较小的时间
     * @return 相差天数
     * @throws
     */
    public static long daysBetween(Date firstDate, Date secondDate){
        firstDate = DateUtils.truncate(firstDate, Calendar.DATE);
        secondDate = DateUtils.truncate(secondDate, Calendar.DATE);
